...
import { mountConsole } from "./console-test-harness";
...
// These tests MOUNT the real console (via ./console-test-harness → mountConsole),
...
// The driver lives in the harness module so every future dead-control audit
// reuses one mount instead of re-deriving it. No effect = the dead-control class
// is back (see 0.1.237–0.1.243).
