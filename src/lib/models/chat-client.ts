 ...
 * key, no OpenAI/ChatGPT key. The only backend is a local Qwen model
...
/**
 * Resolve the keyless local completion backend (local Qwen over HTTP).
...
/**
 * True when a local, loopback-served completion model (Qwen on
