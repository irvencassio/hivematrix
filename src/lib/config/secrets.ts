...
export const KNOWN_SECRETS: SecretSpec[] = [
  ...
  { env: "APCA_API_KEY_ID", label: "Alpaca key id", purpose: "Market data — TraderBee (data only, never trades)" },
  { env: "APCA_API_SECRET_KEY", label: "Alpaca secret", purpose: "Market data — TraderBee (data only, never trades)" },
