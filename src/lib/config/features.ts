...
export const KNOWN_FEATURES = [
  ...
  { key: "openclaw.chatDock", label: "OpenClaw Chat Dock", description: "Show OpenClaw chat at the bottom of the HiveMatrix console. OpenClaw must be installed and its Gateway must be reachable on this Mac." },
] as const;
